...
sets.midcast_phalanx = {
    head={ name="Herculean Helm", augments={'"Cure" spellcasting time -8%','Mag. Acc.+13 "Mag.Atk.Bns."+13','Phalanx +3','Accuracy+3 Attack+3',}},
    hands={ name="Herculean Gloves", augments={'Pet: DEX+7','Phalanx +3',}},
    legs={ name="Herculean Trousers", augments={'STR+5','Pet: INT+9','Phalanx +4',}},
}