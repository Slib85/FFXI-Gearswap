...
cape = {}
cape.fast_cast = { name="Taranus's Cape", augments={'MP+60','Mag. Acc+20 /Mag. Dmg.+20','MP+20','"Fast Cast"+10','Phys. dmg. taken-10%',}}
...
sets.midcast_aspir = set_combine(sets.midcast_magic_accuracy, {
    ...
    legs="Spaekona's Tonban +4",
    hands={ name="Arch. Gloves +4", augments={'Increases Elemental Magic accuracy',}},
...
sets.midcast_waltz = {
    ...
    body="Adamantite Armor",
    hands={ name="Merlinic Dastanas", augments={'"Waltz" potency +10%','"Fast Cast"+2','Accuracy+10 Attack+10',}},
    legs={ name="Merlinic Shalwar", augments={'"Waltz" potency +10%','STR+2','Damage taken-4%','Accuracy+8 Attack+8','Mag. Acc.+3 "Mag.Atk.Bns."+3',}},
    ...
    back={ name="Taranus's Cape", augments={'VIT+20','Eva.+20 /Mag. Eva.+20','VIT+10','"Waltz" potency +10%','Phys. dmg. taken-10%',}},
}
