...
cape = {}
cape.fast_cast = { name="Taranus's Cape", augments={'"Fast Cast"+10',}}
...
sets.precast_magic = {
    ammo = "Sapience Orb", -- 2%
    head={ name="Merlinic Hood", augments={'Attack+25','"Fast Cast"+4','MND+6',}}, --12%
    ...
    waist = "Witful Belt", -- 3%
    legs = "Agwu's Slops", -- 7%
    feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24','"Fast Cast"+4','INT+8','"Mag.Atk.Bns."+6',}}, --9%
    back={ name="Taranus's Cape", augments={'"Fast Cast"+10',}}, -- 10%
}
