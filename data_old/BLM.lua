...
function init_gear_sets()
	...
	sets.midcast['Barstone'] = buffGear
	sets.midcast['Barwater'] = buffGear     
	sets.midcast['Baraero'] = buffGear
	sets.midcast['Barfire'] = buffGear
	sets.midcast['Barblizzard'] = buffGear
	sets.midcast['Barthunder'] = buffGear
	sets.midcast['Barsleep'] = buffGear
	sets.midcast['Barpoison'] = buffGear
	sets.midcast['Barparalyze'] = buffGear
	sets.midcast['Barblind'] = buffGear
	sets.midcast['Barsilence'] = buffGear
	sets.midcast['Barpetrify'] = buffGear
	sets.midcast['Barvirus'] = buffGear
	sets.midcast['Baramnesia'] = buffGear
